...
def _generate_schema_from_mapping(
    schema: DictSchemaType, schema_name: str | None
) -> type[Schema]:
        ...
        *Version changed: 0.4.0*
        ...
        def decorator(f):
            ...
            return parser.use_args(
                schema, location=location, arg_name=arg_name_val, **kwargs
            )(f)
        ...
        def decorator(f):
            ...
            def _jsonify(
                ...
                **kwargs: t.Any,
                ...
                base_schema: OpenAPISchemaType = current_app.config[
