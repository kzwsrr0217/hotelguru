...
def ellipse(svg, node, font_size):
    ...
    svg.stream.curve_to(cx + rx, cy + ratio_y, cx + ratio_x, cy + ry, cx, cy + ry)
    svg.stream.curve_to(cx - ratio_x, cy + ry, cx - rx, cy + ratio_y, cx - rx, cy)
    svg.stream.curve_to(cx - rx, cy - ratio_y, cx - ratio_x, cy - ry, cx, cy - ry)
    svg.stream.curve_to(cx + ratio_x, cy - ry, cx + rx, cy - ratio_y, cx + rx, cy)
    svg.stream.close()
...
def rect(svg, node, font_size):
    ...
    svg.stream.curve_to(x + rx - c1, y + height, x, y + height - c2, x, y + height - ry)
