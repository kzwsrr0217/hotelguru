...
class HTML:
    ...
    def __init__(
        ...
        PROGRESS_LOGGER.info(
            ...
            guess or filename or url or getattr(file_obj, "name", "HTML string"),
        )
    ...
    def write_pdf(
        ...
        **options,
        ...
        new_options.update(options)
        options = new_options
        return self.render(font_config, counter_style, **options).write_pdf(
            target, zoom, finisher, **options
        )
...
def _select_source(
    ...
    selected_params = [
        param for param in (guess, filename, url, file_obj, string) if param is not None
    ]
