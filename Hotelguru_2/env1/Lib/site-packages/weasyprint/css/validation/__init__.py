...
def preprocess_declarations(base_url, declarations, prelude=None):
    ...
    for declaration in declarations:
            ...
            for token_group in token_groups:
                if NESTING_SELECTOR in token_group:
                    ...
                    declaration_prelude.extend(
                        [*is_token, WhitespaceToken(1, 1, " "), *token_group]
                    )
                declaration_prelude.append(LiteralToken(1, 1, ","))
            yield from preprocess_declarations(
                base_url,
                parse_blocks_contents(declaration.content),
        ...
        if name in NOT_PRINT_MEDIA:
            validation_error("debug", "the property does not apply for the print media")
            continue
        ...
        try:
            ...
            validation_error(
                "warning", exc.args[0] if exc.args and exc.args[0] else "invalid value"
            )
            continue
