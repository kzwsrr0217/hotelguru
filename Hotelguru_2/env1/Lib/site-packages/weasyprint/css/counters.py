...
class CounterStyle(dict):
    ...
    def render_value(
        self, counter_value, counter_name=None, counter=None, previous_types=None
    ):
        ...
        if is_negative:
            negative_prefix, negative_suffix = (
                symbol(character)
                for character in counter["negative"]
                or (("string", "-"), ("string", ""))
            )
        ...
        if system == "cyclic":
            ...
            while counter_value != 0:
                ...
                reversed_parts.append(
                    symbol(counter["symbols"][counter_value % length])
                )
