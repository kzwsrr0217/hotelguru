...
def avoid_collisions(context, box, containing_block, outer=True):
    ...
    while True:
        ...
        for shape in excluded_shapes:
            ...
            if (
                (shape_position_y < position_y < shape_position_y + shape_margin_height)
                or (
                    shape_position_y
                ...
                or (
                    shape_position_y >= position_y
                    and shape_position_y + shape_margin_height
                    <= position_y + box_height
                )
            ):
    ...
    assert (
        (box.style["float"] in ("right", "left"))
        or isinstance(box, boxes.LineBox)
        or box.is_table_wrapper
        or isinstance(box, boxes.BlockReplacedBox)
