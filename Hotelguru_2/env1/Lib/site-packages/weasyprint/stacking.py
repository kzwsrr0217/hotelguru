...
class StackingContext:
    ...
    def __init__(self, box, child_contexts, blocks, floats, blocks_and_cells, page):
        self.box = box
        self.page = page
...
def _dispatch(box, page, child_contexts, blocks, floats, blocks_and_cells):
    ...
    defines_stacking_context = (
        ...
        or (box.is_grid_item and style["z_index"] != "auto")
        or style["opacity"] < 1
        or style["transform"]  # 'transform: none' gives a "falsy" empty list
...
def _dispatch_children(box, page, child_contexts, blocks, floats, blocks_and_cells):
