...
PARSER.add_argument("-e", "--encoding", help="force the input character encoding")
PARSER.add_argument(
    "-s",
    "--stylesheet",
    action="append",
...
PARSER.add_argument("--pdf-variant", choices=VARIANTS, help="PDF variant to generate")
PARSER.add_argument("--pdf-version", help="PDF version number")
PARSER.add_argument("--pdf-forms", action="store_true", help="include PDF forms")
PARSER.add_argument(
    "--uncompressed-pdf",
    action="store_true",
...
PARSER.add_argument("--srgb", action="store_true", help="include sRGB color profile")
PARSER.add_argument(
    "--optimize-images",
    action="store_true",
...
PARSER.add_argument(
    "-j", "--jpeg-quality", type=int, help="JPEG quality between 0 (worst) to 95 (best)"
)
PARSER.add_argument(
    "--full-fonts",
    action="store_true",
...
PARSER.add_argument(
    "-D", "--dpi", type=int, help="set maximum resolution of images embedded in the PDF"
)
PARSER.add_argument(
    "-v",
    "--verbose",
...
PARSER.add_argument("-q", "--quiet", action="store_true", help="hide logging messages")
PARSER.add_argument(
    "--version",
    action="version",
