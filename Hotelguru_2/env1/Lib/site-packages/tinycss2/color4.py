...
def _parse_rgb(args, alpha):
    ...
    coordinates = [
        (
            arg.value / 255
            if arg.type == "number"
            else arg.value / 100 if arg.type == "percentage" else None
        )
        for arg in args
    ]
...
def _parse_lab(args, alpha):
    ...
    coordinates = [
        ...
        (
            ...
            else (args[1].value * (1 if args[1].type == "number" else 1.25))
        ),
        (
            None
            if args[2].type == "ident"
            else (args[2].value * (1 if args[2].type == "number" else 1.25))
        ),
    ]
...
def _parse_lch(args, alpha):
    ...
    coordinates = [
        ...
        (
            None
            if args[1].type == "ident"
            else (args[1].value * (1 if args[1].type == "number" else 1.5))
        ),
        None if args[0].type == "ident" else hue,
    ]
...
def _parse_oklab(args, alpha):
    ...
    coordinates = [
        (
            ...
            else (args[0].value * (1 if args[0].type == "number" else 0.01))
        ),
        (
            None
            if args[1].type == "ident"
            else (args[1].value * (1 if args[1].type == "number" else 0.004))
        ),
        (
            None
            if args[2].type == "ident"
            else (args[2].value * (1 if args[2].type == "number" else 0.004))
        ),
    ]
