...
Revision ID: fecc6a4d5cc7
Revises: 
Create Date: 2025-03-30 19:02:36.049527
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('Canceled', 'Live', 'Colsed', name='statusenum'), nullable=False),
    ...
    op.create_table('invoice_service',
